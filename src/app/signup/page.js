...
import { ArrowRight, AtSign, KeyRound, UserPlus, UserRound } from 'lucide-react';
    ...
    <main className="min-h-screen">
      ...
      <section className="relative mx-auto grid min-h-[calc(100vh-80px)] max-w-7xl items-center gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
        ...
        <motion.div
          ...
          className="max-w-xl"
        >
          <div className="mb-4 terminal-badge">signup sequence</div>
          <h1 className="terminal-heading">Create a new build identity.</h1>
          <p className="mt-5 text-sm leading-7 text-emerald-100/75">
            Start your workspace, store resume drafts locally, and move across templates without
            losing structure.
          </p>
        </motion.div>
        ...
        >
          <h2 className="mb-2 font-['VT323'] text-4xl text-emerald-300">[ register ]</h2>
          <p className="mb-8 text-sm text-emerald-100/65">
            Create a workspace profile in seconds.
          </p>
          ...
          <div className="space-y-5">
            <div>
              ...
              <div className="relative">
                <UserRound className="pointer-events-none absolute left-4 top-1/2 h-4 w-4 -translate-y-1/2 text-emerald-400/60" />
                <input
            ...
            <button type="submit" disabled={loading} className="terminal-button-primary w-full">
              {loading ? 'creating profile...' : 'build account'}
